...
function Home() {
    ...
    return (<>
        <div>
            <div className="pt-12 flex justify-center md:gap-56 p-5">
            ...
            <div>
                <div className="relative">
                    ...
                    {/* Form */}
                    <div className="bg-white border border-gray-400 md:block hidden absolute top-[-50px] md:left-[400px] rounded-xl shadow-2xl p-5 ">
                ...
                {/* Form */}
                <div className="bg-white md:hidden border-2 border-black   rounded-xl shadow-2xl p-5  ">
                ...
                <div className="flex flex-col items-center p-4 border  rounded-lg overflow-hidden ">



                    {/* Scrollable Content */}
                    <div className="w-full  overflow-x-auto scrollbar-hidden mt-4  ">
                        <div className="flex space-x-4">

                            <div className="flex-shrink-0   p-4  rounded">
                                <NavLink to={'rental'}>
                                <div>
                                    <img src="https://www.nobroker.in/blog/wp-content/uploads/2024/03/renting-a-house-vs-renting-an-apartment.jpg" alt="" className="h-52  shadow-xl rounded-xl" />
                                    <p className="text-center rounded-xl mt-2 montserrat">Rental</p>
                            ...
                            <div className="flex-shrink-0   p-4 rounded">
                                ...
                                <div>
                                    ...
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQW9fw3heOOzHNWi07NusKT0wAe_VnleFhp_A&s" className="h-52  shadow-xl rounded-xl" alt="" />
                                    <p className=" text-center rounded-xl mt-2 montserrat">Resale</p>
                            ...
                            <div className="flex-shrink-0   p-4 rounded">
                                <div>
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfGz86yvCqKOw5BymCVrADNGcjY2POzwTo1Q&s" className="h-52 shadow-xl rounded-xl" alt="" />
                                    <p className=" text-center rounded-xl mt-2 montserrat">Fresh Addition</p>
                                </div></div>
                            <div className="flex-shrink-0   p-4 rounded">
                                <div>

                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_27q1gJYzkapMkyjsWrec1ThvUehACrMAag&s" className="h-52 shadow-xl rounded-xl" alt="" />
                                    <p className=" text-center rounded-xl mt-2 montserrat">Plot for sale</p>
                            ...
                            <div className="flex-shrink-0   p-4 rounded">
                                <NavLink to={'service'}>
                                <div>
                                <img src="https://postandporch.com/cdn/shop/articles/AdobeStock_209124760.jpg?v=1662575433&width=1440" className="h-52 rounded-xl shadow-xl" alt="" />

                                <p className=" text-center rounded-xl mt-2 montserrat">Services</p>
                            </div>
                            </NavLink>
                            </div>
                ...
                <div className="overflow-auto">
                    <div className=" flex  gap-2 p-5 scrollbar-hidden  w-full ">
