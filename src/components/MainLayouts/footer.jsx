...
function Footer()
{
    return (<>
    <div>
      <div className="bg-purple-800 flex items-center md:flex-row flex-col gap-5 justify-between p-5">
        ...
        <div className="text-white flex gap-5 font-bold dancing-script">
      ...
      <div className="bg-gray-500 text-center p-2 text-black font-bold dancing-script">
