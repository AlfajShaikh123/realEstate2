...
export function Painting() {
    ...
    const [filteredCards, setFilteredCards] = useState(acData);

    const handleSearch = (e) => {
        const searchQuery = e.target.value.toLowerCase();
        setQuery(searchQuery);
        const newFilteredCards = acData.filter((card) =>
            card.agency.toLowerCase().includes(searchQuery)
        );
    ...
    return (
        ...
        <>
            <div className="">
                ...
                <div className="bg-blue-100 mt-24 p-2 fixed top-0 w-full z-20 ">
